...
static const char *CompileLibs[] = {
    /* /net/dagobert/local/work.fh/cm81-git/src_lib/Portings/win64/lib/libcar.a */
    /* /net/dagobert/local/work.fh/cm81-git/src_lib/Portings/win64/lib/libcarmaker.a */
    /* /net/dagobert/local/work.fh/cm81-git/lib/driver/win64/lib/libipgdriver.a */
    /* /net/dagobert/local/work.fh/cm81-git/lib/road/win64/lib/libipgroad.a */
    /* /net/dagobert/local/work.fh/cm81-git/lib/tire/win64/lib/libipgtire.a */
    "libcar.a	CarMaker-Car win64 8.1.2 2020-07-17",
    "libcarmaker.a	CarMaker win64 8.1.2 2020-07-17",
    "libipgdriver.a	IPGDriver win64 8.1 2019-10-31",
    "libipgroad.a	IPGRoad win64 8.1.2 2020-07-06",
...
static const char *CompileFlags[] = {
    "-O3 -DNDEBUG -DWIN32 -DWIN64 -DCM_NUMVER=80102",
...
tAppStartInfo   AppStartInfo = {
    "CarMaker 8.1.2 - Car_Generic",          /* App_Version         */
    "90",          /* App_BuildVersion    */
    "fh",     /* App_CompileUser     */
    "obelix.ipg",         /* App_CompileSystem   */
    "2020-07-17 13:54:36",  /* App_CompileTime */
